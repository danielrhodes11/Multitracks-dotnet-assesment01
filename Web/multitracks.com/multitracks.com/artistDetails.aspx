<%@ Page Language="C#" CodeFile="ArtistDetails.aspx.cs" Inherits="ArtistDetails" %>
...
<body class="premium standard u-fix-fancybox-iframe">
    <form runat="server">
        ...
        <asp:Literal runat="server" ID="artistDetailsLiteral"></asp:Literal>
    ...
    <div class="details-banner">
        ...
        <div class="details-banner--hero">
            <asp:Image runat="server" class="details-banner--hero--img" ID="artistHeroImage" alt="Artist Hero Image" />
            <!-- Artist Details Section -->
            <div class="details-banner--info">
                <a href="#" class="details-banner--info--box">
                    <asp:Image runat="server" class="details-banner--info--box--img" ID="artistImage" />
                </a>
                <h1 class="details-banner--info--name">
                    <asp:HyperLink ID="artistNameLink" runat="server" CssClass="details-banner--info--name--link">
                        <asp:Literal ID="artistNameLiteral" runat="server"></asp:Literal>
                    </asp:HyperLink>
                </h1>
            </div>
        </div>
            ...
            <main class="discovery--section">
                ...
                <section class="standard--holder">
                    ...
                    <ul id="playlist" class="song-list mod-new mod-menu">
                        <asp:Repeater runat="server" ID="topSongsRepeater">
                            <ItemTemplate>
                                <li class="song-list--item media-player--row">
                                    <div class="song-list--item--player-img media-player">
                                        <asp:Image runat="server" class="song-list--item--player-img--img" ID="ArtistImageURL" ImageUrl='<%# Eval("AlbumImageURL") %>' />
                                    </div>
                                    <div class="song-list--item--right">
                                        <a href="#" class="song-list--item--primary">
                                            <asp:Literal ID="songTitleLiteral" runat="server" Text='<%# Eval("SongTitle") %>'></asp:Literal>
                                        </a>
                                        <a class="song-list--item--secondary">
                                            <asp:Literal ID="albumTitleLiteral" runat="server" Text='<%# Eval("AlbumTitle") %>'></asp:Literal>
                                        </a>
                                        <a class="song-list--item--secondary">
                                            <asp:Literal ID="songBPMLiteral" runat="server" Text='<%# Eval("SongBPM") %>'></asp:Literal>
                                            bpm
                                        </a>
                                        <a class="song-list--item--secondary">
                                            <asp:Literal ID="timeSignatureLiteral" runat="server" Text='<%# Eval("TimeSignature") %>'></asp:Literal>
                                        </a>
    ...
    <section class="standard--holder">
        ...
        <div class="discovery--grid-holder">
            <div class="ly-grid ly-grid-cranberries">
                <asp:Repeater runat="server" ID="albumsRepeater">
                    <ItemTemplate>
                        <div class="media-item">
                            <a class="media-item--img--link" href="#" tabindex="0">
                                <asp:Image runat="server" class="media-item--img" ID="albumImage" ImageUrl='<%# Eval("AlbumImageURL") %>' />
                                <span class="image-tag">Master</span>
                            </a>
                            <a class="media-item--title" href="#" tabindex="0">
                                <asp:Literal runat="server" ID="albumTitleLiteral" Text='<%# Eval("AlbumTitle") %>'></asp:Literal>
                            </a>
                            <asp:Literal runat="server" ID="artistNameLiteral" Text='<%# Eval("ArtistTitle") %>'></asp:Literal>
                        </div>
                    </ItemTemplate>
                </asp:Repeater>
            </div><!-- /.ly-grid -->
        </div><!-- /.discovery-grid-holder -->
    </section><!-- /.standard--holder -->
</div><!-- /.discovery--space-saver -->
                ...
                <section class="standard--holder">
                    ...
                    <div class="artist-details--biography biography">
                        <p>
                            <asp:Literal ID="biographyContentLiteral" runat="server"></asp:Literal></p>
                        <a href="#">Read More...</a>
                    </div>
                </section>
            </main>
